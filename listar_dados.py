...
"background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:0.71, y2:0.920909, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(223, 223, 223, 255));")
        ...
        self.pushButton_pesquisar.setGeometry(QtCore.QRect(420, 460, 71, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.pushButton_pesquisar.setFont(font)
        self.pushButton_pesquisar.setStyleSheet("background-color: rgb(58, 58, 58);")
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(740, 20, 75, 23))
        self.pushButton_4.setStyleSheet("background-color: rgb(121, 121, 121);\n"
"color: rgb(255, 255, 255);")
        self.pushButton_4.setObjectName("pushButton_4")
        self.lineEdit_pesquisa = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_pesquisa.setGeometry(QtCore.QRect(470, 20, 271, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_pesquisar.setText(_translate("MainWindow", "PDF"))
